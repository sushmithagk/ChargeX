...
import 'package:chargex/screens/nearby_screen.dart'; // <-- add this for searching the near by station
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        // 👉 Routes you can navigate to with Navigator.pushNamed(context, '/nearby')
        routes: {
